package com.luculent.data.shiro.captcha;
...
import com.luculent.data.utils.util.CaptchaUtils;
import com.luculent.data.utils.util.UUIDBuilder;
...
public class DreamCaptcha implements InitializingBean{
	...
	public void generate(HttpServletRequest request, HttpServletResponse response) {
		...
		if (StringUtils.isBlank(cookieValue)) {
			hasCookie = false;
			cookieValue = UUIDBuilder.getUUID();
		}
